		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comleadleadgenerationm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comleadleadgenerationm-display": {
								"semanticObject": "comleadleadgenerationm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lead.leadgenerationm",
									"url": sap.ui.require.toUrl("com/lead/leadgenerationm")
								}
							}
						}
					}
